...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Here you may specify the paths where users will be redirected after
    | completing various authentication operations. This allows you to
    | customize the post-authentication experience for your application.
    |
    */
